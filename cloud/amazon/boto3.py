...
description:
    ...
    - This module is not idempontent! The idempotency needs to be implemented in the playbook by making additional API calls or reading the return value. This module will always yield a changed state.
version_added: 2.2
requirements:
    - boto3
options:
